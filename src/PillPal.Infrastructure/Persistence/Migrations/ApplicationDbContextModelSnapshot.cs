...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActiveIngredientMedicine", b =>
                {
                    ...
                    b.ToTable("ActiveIngredientMedicine", (string)null);
                });

            modelBuilder.Entity("BrandMedicine", b =>
                {
                    ...
                    b.HasKey("BrandsId", "MedicinesId");

                    b.HasIndex("MedicinesId");

                    b.ToTable("BrandMedicine", (string)null);
                });
            ...
            modelBuilder.Entity("CategoryMedicine", b =>
                {
                    ...
                    b.ToTable("CategoryMedicine", (string)null);
                });
            ...
            modelBuilder.Entity("DosageFormMedicine", b =>
                {
                    ...
                    b.ToTable("DosageFormMedicine", (string)null);
                });

            modelBuilder.Entity("MedicationTakePrescript", b =>
                {
                    b.Property<Guid>("MedicationTakesId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("PrescriptsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("MedicationTakesId", "PrescriptsId");

                    b.HasIndex("PrescriptsId");

                    b.ToTable("MedicationTakePrescript", (string)null);
                });
            ...
            modelBuilder.Entity("MedicinePharmaceuticalCompany", b =>
                {
                    ...
                    b.ToTable("MedicinePharmaceuticalCompany", (string)null);
                });
            ...
            modelBuilder.Entity("PillPal.Core.Models.MedicationTake", b =>
                {
                    ...
                    b.ToTable("MedicationTakes", (string)null);
                });
            ...
            modelBuilder.Entity("PillPal.Core.Models.MedicineInBrand", b =>
                {
                    ...
                    b.ToTable("MedicineInBrands", (string)null);
                });
            ...
            modelBuilder.Entity("PillPal.Core.Models.PharmaceuticalCompany", b =>
                {
                    ...
                    b.ToTable("PharmaceuticalCompanies", (string)null);
                });
            ...
            modelBuilder.Entity("PillPal.Core.Models.PharmacyStore", b =>
                {
                    ...
                    b.ToTable("PharmacyStores", (string)null);
                });
            ...
            modelBuilder.Entity("PillPal.Core.Models.Prescript", b =>
                {
                    ...
                    b.ToTable("Prescripts", (string)null);
                });
            ...
            modelBuilder.Entity("PillPal.Core.Models.PrescriptDetail", b =>
                {
                    ...
                    b.ToTable("PrescriptDetails", (string)null);
                });
            ...
            modelBuilder.Entity("PrescriptPrescriptDetail", b =>
                {
                    ...
                    b.HasKey("PrescriptDetailsId", "PrescriptsId");

                    b.HasIndex("PrescriptsId");

                    b.ToTable("PrescriptPrescriptDetail", (string)null);
                });
            ...
            modelBuilder.Entity("BrandMedicine", b =>
                {
                    b.HasOne("PillPal.Core.Models.Brand", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MedicationTakePrescript", b =>
                {
                    ...
                    b.HasOne("PillPal.Core.Models.Prescript", null)
                        .WithMany()
                        .HasForeignKey("PrescriptsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
